...
| balance-cent-soft                | FaceScrub Set1/LFW | 71.53%/99.33%       |
| balance-reduced                  | FaceScrub Set1/LFW | 70.99%/99.18%       |
| balance-cent-soft  concat mirror | FaceScrub Set1/LFW | 72.73%/99.18%       |
|                                  |                    |                     |
|                                  |                    |                     |
|                                  |                    |                     |
...
- [ ] EasyEnsemble train and test
- [ ] Use matcaffe for metric learning
- [ ] Megaface test
      - - [x] center face
        - [x] balance-cent-soft
        - [x] reduced
        - [ ] mirror or concatenate
        - [ ] EasyEnsemble


- [ ] Paper reading:One-shot face recognition by promoting underrepresented classes

- [ ] ​

      ​

conf.root_path = '/home/yf/Deep-Metric-Learning-CVPR16/code/ebay/';
conf.cache_path = '/home/yf/Deep-Metric-Learning-CVPR16/code/ebay/cache';
conf.image_path = '/home/yf/Deep-Metric-Learning-CVPR16/otherfiles/Stanford_Online_Products/';
...
​            
path_triplet = '/home/yf/Deep-Metric-Learning-CVPR16/data/pairlet/ebay';
